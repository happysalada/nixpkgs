...
let
  sources = {
    ...
    "dynamic-virtualized-list-git+ssh://git@github.com/mattermost/dynamic-virtualized-list.git#119db968c96643c7106d4d2c965f05b2e251bc83" = {
      name = "dynamic-virtualized-list";
      packageName = "dynamic-virtualized-list";
      version = "1.0.0-beta";
      src = fetchgit {
        url = "ssh://git@github.com/mattermost/dynamic-virtualized-list.git";
    ...
    "eslint-plugin-mattermost-git+ssh://git@github.com/mattermost/eslint-plugin-mattermost.git#46ad99355644a719bf32082f472048f526605181" = {
      name = "eslint-config-mattermost";
      packageName = "eslint-config-mattermost";
      version = "1.0.0";
      src = fetchgit {
        url = "ssh://git@github.com/mattermost/eslint-plugin-mattermost.git";
    ...
    "marked-git+ssh://git@github.com/mattermost/marked.git#be741d411d4642c4cd3e009645f4cb6baa7e92bb" = {
      name = "marked";
      packageName = "marked";
      version = "0.3.6";
      src = fetchgit {
        url = "ssh://git@github.com/mattermost/marked.git";
    ...
    "mmjstool-git+ssh://git@github.com/mattermost/mattermost-utilities.git#40d7640e85385248773504548ef962037ac842ea" = {
      name = "mmjstool";
      packageName = "mmjstool";
      version = "1.0.0";
      src = fetchgit {
        url = "ssh://git@github.com/mattermost/mattermost-utilities.git";
    ...
    "react-bootstrap-git+ssh://git@github.com/mattermost/react-bootstrap.git#c6957962364e0818a51bbfd13e89919903b422d6" = {
      name = "react-bootstrap";
      packageName = "react-bootstrap";
      version = "0.32.4";
      src = fetchgit {
        url = "ssh://git@github.com/mattermost/react-bootstrap.git";
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."dynamic-virtualized-list-git+ssh://git@github.com/mattermost/dynamic-virtualized-list.git#119db968c96643c7106d4d2c965f05b2e251bc83" // {
        dependencies = [
      ...
      sources."eslint-plugin-mattermost-git+ssh://git@github.com/mattermost/eslint-plugin-mattermost.git#46ad99355644a719bf32082f472048f526605181"
      ...
      sources."marked-git+ssh://git@github.com/mattermost/marked.git#be741d411d4642c4cd3e009645f4cb6baa7e92bb"
      ...
      sources."mkdirp-0.5.5"
      (sources."mmjstool-git+ssh://git@github.com/mattermost/mattermost-utilities.git#40d7640e85385248773504548ef962037ac842ea" // {
        dependencies = [
          sources."ansi-regex-4.1.0"
          sources."camelcase-5.3.1"
          sources."cliui-5.0.0"
      ...
      (sources."react-bootstrap-git+ssh://git@github.com/mattermost/react-bootstrap.git#c6957962364e0818a51bbfd13e89919903b422d6" // {
        dependencies = [
